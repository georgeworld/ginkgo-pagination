 ...
 */
public class PaginationChangeLogPanel extends javax.swing.JPanel {

    private Class<?> clazz;

    /** Creates new form ChangeLogPanel */
    public PaginationChangeLogPanel(Class<?> clazz) {
        this.clazz = clazz;
        initComponents();
        initTable();
    }
    ...
    public DefaultTableModel getTableModel() {
        ...
        PaginationComments commentsAnnotation = clazz.getAnnotation(PaginationComments.class);
        if (commentsAnnotation != null) {
            PaginationCommentItem[] commentItems = commentsAnnotation.value();
            if (commentItems != null) {
                for (PaginationCommentItem item : commentItems) {
